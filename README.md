...
**Текущий статус:** Фаза 2 в процессе. Этап 2.3 (Визуализация AST) — выполнен: реализована интерактивная визуализация AST с подсветкой соответствия между исходным кодом и узлами дерева, кнопки Expand/Collapse All, отображение позиций узлов.
